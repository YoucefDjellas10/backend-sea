        ...
        if country_code =="DZ":
            ...
            if ma_reservation :
                result.append({
                    ...
                    'opt_payment_price': float(ma_reservation.opt_payment_price) * float(taux_change) if ma_reservation.opt_payment_price else 0.00,
                    'opt_payment_total': float(ma_reservation.opt_payment_total) * float(taux_change) if ma_reservation.opt_payment_total else 0.00,
                    'opt_klm': ma_reservation.opt_klm_name ,
                    'opt_kilometrage': ma_reservation.opt_kilometrage,
                    'opt_klm_price': float(ma_reservation.opt_klm_price) * float(taux_change) if ma_reservation.opt_klm_price else 0.00,
                    'opt_klm_total': float(ma_reservation.opt_klm_total) * float(taux_change) if ma_reservation.opt_klm_total else 0.00,
                    'opt_protection': ma_reservation.opt_protection_name,
                    'opt_protection_caution': float(ma_reservation.opt_protection_caution) * float(taux_change) if ma_reservation.opt_protection_caution else 0.00,
                    'opt_protection_price': float(ma_reservation.opt_protection_price) * float(taux_change) if ma_reservation.opt_protection_price else 0.00,
                    'opt_protection_total': float(ma_reservation.opt_protection_total) * float(taux_change) if ma_reservation.opt_protection_total else 0.00,
                    'opt_nd_driver': ma_reservation.opt_nd_driver_name,
                    'opt_nd_driver_price': float(ma_reservation.opt_nd_driver_price) * float(taux_change) if ma_reservation.opt_nd_driver_price else 0.00,
                    'opt_nd_driver_total': float(ma_reservation.opt_nd_driver_total) * float(taux_change) if ma_reservation.opt_nd_driver_total else 0.00,
                    'opt_plein_carburant': ma_reservation.opt_plein_carburant_name,
                    'opt_plein_carburant_price': float(ma_reservation.opt_plein_carburant_prix) * float(taux_change) if ma_reservation.opt_plein_carburant_prix else 0,
                    'opt_plein_carburant_total': float(ma_reservation.opt_plein_carburant_total) * float(taux_change) if ma_reservation.opt_plein_carburant_total else 0,
                    'opt_siege_a': ma_reservation.opt_siege_a_name,
                    'opt_siege_a_price': float(ma_reservation.opt_siege_a_prix) * float(taux_change) if ma_reservation.opt_siege_a_prix else 0.00,
                    'opt_siege_a_total': float(ma_reservation.opt_siege_a_total) * float(taux_change) if ma_reservation.opt_siege_a_total else 0.00,
                    'opt_siege_b': ma_reservation.opt_siege_b_name,
                    'opt_siege_b_price': float(ma_reservation.opt_siege_b_prix) * float(taux_change) if ma_reservation.opt_siege_b_prix else 0.0,
                    'opt_siege_b_total': float(ma_reservation.opt_siege_b_total) * float(taux_change) if ma_reservation.opt_siege_b_total else 0.0,
                    'opt_siege_c': ma_reservation.opt_siege_c_name,
                    'opt_siege_c_price': float(ma_reservation.opt_siege_c_prix) * float(taux_change) if ma_reservation.opt_siege_c_prix else 0.0,
                    'opt_siege_c_total': float(ma_reservation.opt_siege_c_total) * float(taux_change) if ma_reservation.opt_siege_c_total else 0.0,
                    ...
                    'total_reduit_euro': float(ma_reservation.total_reduit_euro) * float(taux_change) if ma_reservation.total_reduit_euro else 0.0,
