...
urlpatterns += [
    ...
    path("complement-payment-session-reservation/", create_complement_payment_reservation, name="create_complement_payment_reservation"),
    ...
    path("stripe-webhook-reservation/", stripe_webhook_reservation_, name="stripe_webhook_reservation"),
    ...
    path('inspection-report/generate-token/', generate_pickup_token_view, name='generate_pickup_token'),  # ✅ AJOUTER
