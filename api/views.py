        ...
        if type_id == "reservation":
            ...
            if reservation.status != "confirmee" :
                ...
                livraison = Livraison.objects.create(
                    ...
                    opt_carburant = reservation.opt_plein_carburant if reservation.opt_plein_carburant else None,
                    ...
                    opt_sb_b = reservation.opt_siege_b if reservation.opt_siege_b else None,
                    opt_sb_b_check = True if reservation.opt_siege_b else False,
                    opt_sb_c = reservation.opt_siege_c if reservation.opt_siege_c else None,
