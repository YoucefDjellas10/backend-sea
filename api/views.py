...
def add_reservation_post_view(request):
    try:
        ...
        reservation = Reservation.objects.create(
            ...
            opt_klm_price = float(opt_klm_unit),
            opt_klm_total = Decimal(opt_klm_total),
            opt_payment = paiement_anticipe,
            opt_payment_name = opt_payment_name,
            opt_payment_price = float(opt_payment_unit),
            opt_payment_total = Decimal(opt_payment_total),
            opt_protection = protection,
            opt_protection_name = protection_name,
            opt_protection_caution= Decimal(protection_caution),
            opt_protection_price=float(protection_unit),
            opt_protection_total=Decimal(protection_total),
            opt_nd_driver=nd_driver_opt,
            opt_nd_driver_name=nd_driver_opt_name,
            opt_nd_driver_price=float(nd_driver_opt_unit),
            opt_nd_driver_total=Decimal(nd_driver_opt_total),
            opt_plein_carburant=carburant,
            opt_plein_carburant_name=carburant_name,
            opt_plein_carburant_prix= float(carburant_unit),
            opt_plein_carburant_total=Decimal(carburant_total),
            opt_siege_a = sb_a,
            opt_siege_a_name=sb_a_name,
            opt_siege_a_prix=float(sb_a_unit),
            opt_siege_a_total=Decimal(sb_a_total),
            opt_siege_b = sb_b,
            opt_siege_b_name= sb_b_name,
            opt_siege_b_prix=float(sb_b_unit),
            opt_siege_b_total=Decimal(sb_b_total),
            opt_siege_c=sb_c,
            opt_siege_c_prix=float(sb_c_unit),
            opt_siege_c_name=sb_c_name,
            opt_siege_c_total=(Decimalsb_c_total),
            num_vol=num_vol,
